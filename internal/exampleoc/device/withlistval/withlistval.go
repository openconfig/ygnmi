...
// ModelAny represents the wildcard version of the /openconfig-withlistval/model YANG schema element.
...
// Model_MultiKeyAny represents the wildcard version of the /openconfig-withlistval/model/b/multi-key YANG schema element.
type Model_MultiKeyAny struct {
	*ygot.NodePath
}

// Model_MultiKey_Key1 represents the /openconfig-withlistval/model/b/multi-key/state/key1 YANG schema element.
type Model_MultiKey_Key1 struct {
	parent ygot.PathStruct
}

// Model_MultiKey_Key1Any represents the wildcard version of the /openconfig-withlistval/model/b/multi-key/state/key1 YANG schema element.
type Model_MultiKey_Key1Any struct {
	parent ygot.PathStruct
}

// Model_MultiKey_Key2 represents the /openconfig-withlistval/model/b/multi-key/state/key2 YANG schema element.
type Model_MultiKey_Key2 struct {
	parent ygot.PathStruct
}

// Model_MultiKey_Key2Any represents the wildcard version of the /openconfig-withlistval/model/b/multi-key/state/key2 YANG schema element.
...
// Model_SingleKeyAny represents the wildcard version of the /openconfig-withlistval/model/a/single-key YANG schema element.
type Model_SingleKeyAny struct {
	*ygot.NodePath
}

// Model_SingleKey_Key represents the /openconfig-withlistval/model/a/single-key/state/key YANG schema element.
type Model_SingleKey_Key struct {
	parent ygot.PathStruct
}

// Model_SingleKey_KeyAny represents the wildcard version of the /openconfig-withlistval/model/a/single-key/state/key YANG schema element.
type Model_SingleKey_KeyAny struct {
	parent ygot.PathStruct
}

// Model_SingleKey_Value represents the /openconfig-withlistval/model/a/single-key/state/value YANG schema element.
type Model_SingleKey_Value struct {
	parent ygot.PathStruct
}

// Model_SingleKey_ValueAny represents the wildcard version of the /openconfig-withlistval/model/a/single-key/state/value YANG schema element.
type Model_SingleKey_ValueAny struct {
	parent ygot.PathStruct
}
...
// Note: The returned struct does not implement the PathStruct interface.
func (n *Model_SingleKey) Value() *Model_SingleKey_Value {
	return &Model_SingleKey_Value{
		parent: n,
	}
}
...
// Value corresponds to an ambiguous path; use .Config() or .State() to get a resolved path for this leaf.
// Note: The returned struct does not implement the PathStruct interface.
func (n *Model_SingleKeyAny) Value() *Model_SingleKey_ValueAny {
	return &Model_SingleKey_ValueAny{
		parent: n,
	}
}
...
func (n *Model_SingleKey_Value) State() ygnmi.SingletonQuery[int64] {
...
// Path from parent: "state/value"
// Path from root: "/model/a/single-key/state/value"
func (n *Model_SingleKey_ValueAny) State() ygnmi.WildcardQuery[int64] {
...
func (n *Model_SingleKey_Value) Config() ygnmi.ConfigQuery[int64] {
...
// Path from parent: "config/value"
// Path from root: "/model/a/single-key/config/value"
func (n *Model_SingleKey_ValueAny) Config() ygnmi.WildcardQuery[int64] {
	return ygnmi.NewLeafWildcardQuery[int64](
		"Model_SingleKey",
		false,
		true,
