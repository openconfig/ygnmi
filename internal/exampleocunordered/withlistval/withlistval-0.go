...
// PathOrigin returns the name of the origin for the path object.
func (n *Model_SingleKey_OrderedList_KeyPath) PathOriginName() string {
	return ""
}
...
func (n *Model_SingleKey_OrderedList_KeyPath) State() ygnmi.SingletonQuery[string] {
	return ygnmi.NewSingletonQuery[string](
		...
		func(gs ygot.ValidatedGoStruct) (string, bool) {
			ret := gs.(*oc.Model_SingleKey_OrderedList).Key
			if ret == nil {
				var zero string
				return zero, false
			}
		...
		func() ygot.ValidatedGoStruct { return new(oc.Model_SingleKey_OrderedList) },
		func() *ytypes.Schema {
			return &ytypes.Schema{
				Root:       &oc.Root{},
				SchemaTree: oc.SchemaTree,
...
// PathOrigin returns the name of the origin for the path object.
func (n *Model_SingleKey_OrderedList_ValuePath) PathOriginName() string {
	return ""
}
...
func (n *Model_SingleKey_OrderedList_ValuePath) State() ygnmi.SingletonQuery[int64] {
	return ygnmi.NewSingletonQuery[int64](
		...
		func(gs ygot.ValidatedGoStruct) (int64, bool) {
			ret := gs.(*oc.Model_SingleKey_OrderedList).Value
			if ret == nil {
				var zero int64
				return zero, false
			}
...
func (n *Model_SingleKey_OrderedListPath) State() ygnmi.SingletonQuery[*oc.Model_SingleKey_OrderedList] {
	return ygnmi.NewSingletonQuery[*oc.Model_SingleKey_OrderedList](
		"Model_SingleKey_OrderedList",
		true,
		false,
		false,
...
func (n *Model_SingleKey_OrderedListPathAny) State() ygnmi.WildcardQuery[*oc.Model_SingleKey_OrderedList] {
	return ygnmi.NewWildcardQuery[*oc.Model_SingleKey_OrderedList](
		"Model_SingleKey_OrderedList",
		true,
		false,
		false,
...
func (n *Model_SingleKey_OrderedListPath) Config() ygnmi.ConfigQuery[*oc.Model_SingleKey_OrderedList] {
	return ygnmi.NewConfigQuery[*oc.Model_SingleKey_OrderedList](
		"Model_SingleKey_OrderedList",
		false,
		true,
		false,
...
// PathOrigin returns the name of the origin for the path object.
func (n *Model_SingleKey_SingleKey_KeyPath) PathOriginName() string {
	return ""
}
...
// PathOrigin returns the name of the origin for the path object.
func (n *Model_SingleKey_SingleKey_ValuePath) PathOriginName() string {
	return ""
}
