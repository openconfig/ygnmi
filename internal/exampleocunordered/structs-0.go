...
type Model_SingleKey struct {
	...
	OrderedList map[string]*Model_SingleKey_OrderedList `path:"ordered-lists/ordered-list" module:"openconfig-withlistval/openconfig-withlistval"`
...
// Model_SingleKey struct. The keys of the list are populated from the input
// arguments.
func (t *Model_SingleKey) NewOrderedList(Key string) (*Model_SingleKey_OrderedList, error) {

	// Initialise the list within the receiver struct if it has not already been
	// created.
	if t.OrderedList == nil {
		t.OrderedList = make(map[string]*Model_SingleKey_OrderedList)
	}
	...
	t.OrderedList[key] = &Model_SingleKey_OrderedList{
		Key: &Key,
	}
...
// GetOrCreateOrderedListMap returns the list (map) from Model_SingleKey.
//
// It initializes the field if not already initialized.
func (t *Model_SingleKey) GetOrCreateOrderedListMap() map[string]*Model_SingleKey_OrderedList {
	if t.OrderedList == nil {
		t.OrderedList = make(map[string]*Model_SingleKey_OrderedList)
	}
...
// the receiver Model_SingleKey. If the entry does not exist, then it is created.
// It returns the existing or new list member.
func (t *Model_SingleKey) GetOrCreateOrderedList(Key string) *Model_SingleKey_OrderedList {
...
// the OrderedList map field of Model_SingleKey. If the receiver is nil, or
// the specified key is not present in the list, nil is returned such that Get*
// methods may be safely chained.
func (t *Model_SingleKey) GetOrderedList(Key string) *Model_SingleKey_OrderedList {
...
// the receiver Model_SingleKey. If there is no such element, the function
// is a no-op.
func (t *Model_SingleKey) DeleteOrderedList(Key string) {
	key := Key

	delete(t.OrderedList, key)
}

// AppendOrderedList appends the supplied Model_SingleKey_OrderedList struct to the
// list OrderedList of Model_SingleKey. If the key value(s) specified in
// the supplied Model_SingleKey_OrderedList already exist in the list, an error is
// returned.
func (t *Model_SingleKey) AppendOrderedList(v *Model_SingleKey_OrderedList) error {
	if v.Key == nil {
		return fmt.Errorf("invalid nil key received for Key")
	}
