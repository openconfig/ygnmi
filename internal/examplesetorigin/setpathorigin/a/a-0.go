...
import (
	...
	oc "github.com/openconfig/ygnmi/internal/examplesetorigin/setpathorigin"
...
// Model_SingleKey_NestedList_KeyPath represents the /openconfig-withlistval/model/a/single-key/nested-lists/nested-list/config/key YANG schema element.
type Model_SingleKey_NestedList_KeyPath struct {
	*ygnmi.NodePath
	parent ygnmi.PathStruct
}

// Model_SingleKey_NestedList_KeyPathAny represents the wildcard version of the /openconfig-withlistval/model/a/single-key/nested-lists/nested-list/config/key YANG schema element.
...
// Model_SingleKey_NestedList_ValuePath represents the /openconfig-withlistval/model/a/single-key/nested-lists/nested-list/config/value YANG schema element.
type Model_SingleKey_NestedList_ValuePath struct {
	*ygnmi.NodePath
	parent ygnmi.PathStruct
}

// Model_SingleKey_NestedList_ValuePathAny represents the wildcard version of the /openconfig-withlistval/model/a/single-key/nested-lists/nested-list/config/value YANG schema element.
