...
// GetKey retrieves the value of the leaf Key from the Model_NoKey
// struct. If the field is unset but has a default value in the YANG schema,
// then the default value will be returned.
// Caution should be exercised whilst using this method since when without a
// default value, it will return the Go zero value if the field is explicitly
...
func (t *Model_NoKey) GetKey() string {
	if t == nil || t.Key == nil {
		return ""
	}
	return *t.Key
...
// GetValue retrieves the value of the leaf Value from the Model_NoKey
// struct. If the field is unset but has a default value in the YANG schema,
// then the default value will be returned.
// Caution should be exercised whilst using this method since when without a
// default value, it will return the Go zero value if the field is explicitly
...
func (t *Model_NoKey) GetValue() int64 {
...
// SetKey sets the value of the leaf Key in the Model_NoKey
// struct.
func (t *Model_NoKey) SetKey(v string) {
	t.Key = &v
}

// SetValue sets the value of the leaf Value in the Model_NoKey
// struct.
func (t *Model_NoKey) SetValue(v int64) {
	t.Value = &v
}
