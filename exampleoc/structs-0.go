...
type Component struct {
	...
	Name       *string                    `path:"state/name|name" module:"openconfig-unione/openconfig-unione|openconfig-unione" shadow-path:"config/name|name" shadow-module:"openconfig-unione/openconfig-unione|openconfig-unione"`
