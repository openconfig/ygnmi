...
type Model struct {
	...
	OrderedList *Model_OrderedList_OrderedMap          `path:"ordered-lists/ordered-list" module:"openconfig-withlistval/openconfig-withlistval"`
...
func (s *Model) AppendNewOrderedList(Key string) (*Model_OrderedList, error) {
	if s.OrderedList == nil {
		s.OrderedList = &Model_OrderedList_OrderedMap{}
	}
	return s.OrderedList.AppendNew(Key)
}

// AppendOrderedList appends the supplied Model_OrderedList struct
// to the list OrderedList of Model. If the key value(s)
// specified in the supplied Model_OrderedList already exist in the list, an
// error is returned.
func (s *Model) AppendOrderedList(v *Model_OrderedList) error {
	if s.OrderedList == nil {
		s.OrderedList = &Model_OrderedList_OrderedMap{}
	}
...
// function is a no-op.
func (s *Model) DeleteOrderedList(Key string) bool {
	key := Key
	return s.OrderedList.Delete(key)
}

// Model_OrderedList_OrderedMap is an ordered map that represents the "ordered-by user"
// list elements at /openconfig-withlistval/model/ordered-lists/ordered-list.
type Model_OrderedList_OrderedMap struct {
	keys     []string
	valueMap map[string]*Model_OrderedList
}

// IsYANGOrderedList ensures that Model_OrderedList_OrderedMap implements the
// ygot.GoOrderedMap interface.
func (*Model_OrderedList_OrderedMap) IsYANGOrderedList() {}

// init initializes any uninitialized values.
func (o *Model_OrderedList_OrderedMap) init() {
	if o == nil {
		return
	}
	if o.valueMap == nil {
		o.valueMap = map[string]*Model_OrderedList{}
	}
}

// Keys returns a copy of the list's keys.
func (o *Model_OrderedList_OrderedMap) Keys() []string {
	if o == nil {
		return nil
	}
...
func (o *Model_OrderedList_OrderedMap) Values() []*Model_OrderedList {
	if o == nil {
		return nil
	}
	var values []*Model_OrderedList
...
// Len returns a size of Model_OrderedList_OrderedMap
func (o *Model_OrderedList_OrderedMap) Len() int {
	if o == nil {
		return 0
	}
	return len(o.keys)
...
// is returned.
func (o *Model_OrderedList_OrderedMap) Get(key string) *Model_OrderedList {
	if o == nil {
		return nil
	}
...
func (o *Model_OrderedList_OrderedMap) Delete(key string) bool {
	if o == nil {
		return false
	}
...
// Append appends a Model_OrderedList, returning an error if the key
// already exists in the ordered list or if the key is unspecified.
func (o *Model_OrderedList_OrderedMap) Append(v *Model_OrderedList) error {
	if o == nil {
		return fmt.Errorf("nil ordered map, cannot append Model_OrderedList")
	}
	if v == nil {
		return fmt.Errorf("nil Model_OrderedList")
	}
	if v.Key == nil {
		return fmt.Errorf("invalid nil key received for Key")
	}
...
// AppendNew creates and appends a new Model_OrderedList, returning the
// newly-initialized v. It returns an error if the v already exists.
func (o *Model_OrderedList_OrderedMap) AppendNew(Key string) (*Model_OrderedList, error) {
	if o == nil {
		return nil, fmt.Errorf("nil ordered map, cannot append Model_OrderedList")
	}
	key := Key
...
// Model_OrderedList represents the /openconfig-withlistval/model/ordered-lists/ordered-list YANG schema element.
type Model_OrderedList struct {
...
// IsYANGGoStruct ensures that Model_OrderedList implements the yang.GoStruct
// interface. This allows functions that need to handle this struct to
// identify it as being generated by ygen.
func (*Model_OrderedList) IsYANGGoStruct() {}

// GetKey retrieves the value of the leaf Key from the Model_OrderedList
// struct. If the field is unset but has a default value in the YANG schema,
// then the default value will be returned.
// Caution should be exercised whilst using this method since when without a
// default value, it will return the Go zero value if the field is explicitly
...
// caller has different actions based on whether the leaf is set or unset, it
// should use 'if t.Key == nil' before retrieving the leaf's value.
func (t *Model_OrderedList) GetKey() string {
	if t == nil || t.Key == nil {
		return ""
	}
	return *t.Key
...
// GetValue retrieves the value of the leaf Value from the Model_OrderedList
// struct. If the field is unset but has a default value in the YANG schema,
// then the default value will be returned.
// Caution should be exercised whilst using this method since when without a
// default value, it will return the Go zero value if the field is explicitly
...
// caller has different actions based on whether the leaf is set or unset, it
// should use 'if t.Value == nil' before retrieving the leaf's value.
func (t *Model_OrderedList) GetValue() int64 {
	if t == nil || t.Value == nil {
		return 0
	}
	return *t.Value
...
// SetKey sets the value of the leaf Key in the Model_OrderedList
// struct.
func (t *Model_OrderedList) SetKey(v string) {
	t.Key = &v
}

// SetValue sets the value of the leaf Value in the Model_OrderedList
// struct.
func (t *Model_OrderedList) SetValue(v int64) {
	t.Value = &v
}

// PopulateDefaults recursively populates unset leaf fields in the Model_OrderedList
// with default values as specified in the YANG schema, instantiating any nil
// container fields.
func (t *Model_OrderedList) PopulateDefaults() {
	if t == nil {
		return
	}
	ygot.BuildEmptyTree(t)
...
// ΛListKeyMap returns the keys of the Model_OrderedList struct, which is a YANG list entry.
func (t *Model_OrderedList) ΛListKeyMap() (map[string]interface{}, error) {
	if t.Key == nil {
...
// Validate validates s against the YANG schema corresponding to its type.
func (t *Model_OrderedList) ΛValidate(opts ...ygot.ValidationOption) error {
	if err := ytypes.Validate(SchemaTree["Model_OrderedList"], t, opts...); err != nil {
		return err
	}
	return nil
}
...
// Validate validates s against the YANG schema corresponding to its type.
func (t *Model_OrderedList) Validate(opts ...ygot.ValidationOption) error {
	return t.ΛValidate(opts...)
}

// ΛEnumTypeMap returns a map, keyed by YANG schema path, of the enumerated types
// that are included in the generated code.
func (t *Model_OrderedList) ΛEnumTypeMap() map[string][]reflect.Type { return ΛEnumTypes }

// ΛBelongingModule returns the name of the module that defines the namespace
// of Model_OrderedList.
func (*Model_OrderedList) ΛBelongingModule() string {
	return "openconfig-withlistval"
}
